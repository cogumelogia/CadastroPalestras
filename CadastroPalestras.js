...
if (dataEscolhida > dataAtual){
    console.log (`${dataEscolhida.toLocaleDateString("pt-BR")}`); 
...
/// Implementei função nativa do javascript para arrumar a data em modelo DD/MM/AAAA.
/// Porém ainda não achei uma solução para a inserção de dados ser através do modelo de data brasileiro.
